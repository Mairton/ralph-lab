...
- O `<p id="conclusao">` e o **unico** `<p>` da pagina (validador externo le o primeiro `<p>`); subtitulo e qualquer texto auxiliar usam `<div>`/`<span>`. Coberto por `test_html_conclusao_e_unico_p`.
